...
\begin{document}
	...
	\begin{Definicija}
		...
		\begin{itemize}
			...
			\item
			Naj bodo $(A_i)_{i \ge 1} $ paroma nezdružljivi dogodki. Potem velja: $(A_i \cap A_j = \emptyset)_{i\neq j}$.
			\item
	...
	\begin{Definicija}
		...
		Potem je  za $B\in \mathcal{F}$ definirano $$P(A|B) = \frac{P(A \cap B)}{P(A)} \Rightarrow P(A\cap B) = P(A) \cdot P(A|B)$$
...
\end{Definicija}
\begin{Trditev} 
Naj bojo X,Y,Z slučajne spremenljivke na  $(\Omega,\mathcal{F},P)$. Nadalje naj velja, da sta števili $a$ in $b\in \mathbb{R}$. Potem velja:
\begin{itemize}
\item
